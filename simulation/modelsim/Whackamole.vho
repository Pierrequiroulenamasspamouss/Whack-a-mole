...
-- Equation(s):
-- \startButton_prev~regout\ = DFFEAS((((!\startButton~combout\))), GLOBAL(\fastclock~combout\), VCC, , , , , , )
...
\lfsr[2]\ : maxv_lcell
-- Equation(s):
-- \spawn_idx~3\ = (lfsr(0) & (((!lfsr(3))))) # (!lfsr(0) & (lfsr(3) & ((lfsr(1)) # (lfsr[2]))))
...
\lfsr[1]\ : maxv_lcell
-- Equation(s):
-- \spawn_idx~2\ = (lfsr(0) & (((lfsr[1])))) # (!lfsr(0) & ((lfsr[1] & ((!lfsr(3)))) # (!lfsr[1] & (lfsr(2) & lfsr(3)))))
...
-- Equation(s):
-- \Decoder0~0_combout\ = ((\Equal2~1_combout\ & ((!mole_active(8)) # (!\spawn_idx~0\))))
...
-- Equation(s):
-- \mole_duration~12_combout\ = (mole_active(6) & (mole_duration(6) & ((button_prev(6)) # (!\button~combout\(6)))))
...
-- Equation(s):
-- \Decoder0~12_combout\ = (\spawn_idx~1_combout\ & (!\spawn_idx~3\ & (\spawn_idx~2\ & \Decoder0~4_combout\)))
...
-- Equation(s):
-- mole_duration(6) = DFFEAS((mole_duration(6) & (((!\mole_duration~12_combout\)) # (!\Equal2~1_combout\))) # (!mole_duration(6) & (\Decoder0~12_combout\ & ((!\mole_duration~12_combout\) # (!\Equal2~1_combout\)))), GLOBAL(\fastclock~combout\), VCC, , 
-- \game_state~regout\, , , , )
...
PORT MAP (
	...
	datac => \mole_duration~12_combout\,
...
-- Equation(s):
-- \Decoder0~11_combout\ = (\spawn_idx~1_combout\ & (\spawn_idx~3\ & (!\spawn_idx~2\ & \Decoder0~4_combout\)))
...
-- Equation(s):
-- \mole_active~5_combout\ = (mole_duration(5)) # ((global_tick(5)) # ((global_tick(4)) # (!\Equal2~0_combout\)))
...
-- Equation(s):
-- \Decoder0~9_combout\ = (\spawn_idx~3\ & (!\spawn_idx~1_combout\ & (\spawn_idx~2\ & \Decoder0~4_combout\)))
...
-- Equation(s):
-- \mole_active~3_combout\ = (mole_duration(3)) # ((global_tick(5)) # ((global_tick(4)) # (!\Equal2~0_combout\)))
...
-- Equation(s):
-- \Decoder0~10_combout\ = (!\spawn_idx~3\ & (\spawn_idx~1_combout\ & (!\spawn_idx~2\ & \Decoder0~4_combout\)))
...
-- Equation(s):
-- \mole_duration~8_combout\ = (mole_active(4) & (mole_duration(4) & ((button_prev(4)) # (!\button~combout\(4)))))
...
-- Equation(s):
-- \mole_active~4_combout\ = (mole_duration(4)) # ((global_tick(5)) # ((global_tick(4)) # (!\Equal2~0_combout\)))
...
\mole_active[4]\ : maxv_lcell
-- Equation(s):
-- mole_active(4) = DFFEAS((mole_active(4) & (!\moles_fsm_proc~4\ & ((\mole_active~4_combout\)))) # (!mole_active(4) & (((\Decoder0~10_combout\)))), GLOBAL(\fastclock~combout\), VCC, , , , , !\game_state~regout\, )
...
PORT MAP (
	clk => \fastclock~combout\,
	dataa => mole_active(4),
	datab => \moles_fsm_proc~4\,
	datac => \Decoder0~10_combout\,
	datad => \mole_active~4_combout\,
	aclr => GND,
	sclr => \ALT_INV_game_state~regout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Decoder0~7_combout\ = ((\spawn_idx~3\ & (\Decoder0~5_combout\ & \Decoder0~4_combout\)))
...
-- Equation(s):
-- \mole_active~1_combout\ = (mole_duration(1)) # ((global_tick(5)) # ((global_tick(4)) # (!\Equal2~0_combout\)))
...
-- Equation(s):
-- \Decoder0~8_combout\ = (!\spawn_idx~3\ & (!\spawn_idx~1_combout\ & (\spawn_idx~2\ & \Decoder0~4_combout\)))
...
-- Equation(s):
-- \mole_active~2_combout\ = (mole_duration(2)) # ((global_tick(5)) # ((global_tick(4)) # (!\Equal2~0_combout\)))
...
-- Equation(s):
-- \mole_duration~0_combout\ = (mole_active(0) & (mole_duration(0) & ((button_prev(0)) # (!\button~combout\(0)))))
...
-- Equation(s):
-- \Decoder0~6_combout\ = ((!\spawn_idx~3\ & (\Decoder0~5_combout\ & \Decoder0~4_combout\)))
...
\mole_duration[0]\ : maxv_lcell
-- Equation(s):
-- mole_duration(0) = DFFEAS((\mole_duration~0_combout\ & (!\Equal2~1_combout\ & ((mole_duration(0)) # (\Decoder0~6_combout\)))) # (!\mole_duration~0_combout\ & (((mole_duration(0)) # (\Decoder0~6_combout\)))), GLOBAL(\fastclock~combout\), VCC, , 
-- \game_state~regout\, , , , )
...
-- Equation(s):
-- \mole_active~0_combout\ = (mole_duration(0)) # ((global_tick(5)) # ((global_tick(4)) # (!\Equal2~0_combout\)))
...
\Add5~0\ : maxv_lcell
-- Equation(s):
-- \Add5~0_combout\ = (mole_active(1) $ (mole_active(2) $ (mole_active(0))))
...
\Add7~0\ : maxv_lcell
-- Equation(s):
-- \Add7~0_combout\ = (mole_active(3) $ (mole_active(4) $ (\Add5~0_combout\)))
...
\Add7~2\ : maxv_lcell
-- Equation(s):
-- \Add7~2_combout\ = (\Add5~1_combout\ & ((mole_active(4) & ((mole_active(3)) # (\Add5~0_combout\))) # (!mole_active(4) & (mole_active(3) & \Add5~0_combout\))))
...
-- Equation(s):
-- \mole_active~7_combout\ = ((mole_duration(7)) # ((global_tick(4)) # (global_tick(5)))) # (!\Equal2~0_combout\)
...
-- Equation(s):
-- \Decoder0~15_combout\ = (!\spawn_idx~3\ & (\spawn_idx~0\ & (\Decoder0~5_combout\ & \Decoder0~14_combout\)))
...
\mole_active[8]\ : maxv_lcell
-- Equation(s):
-- mole_active(8) = DFFEAS((mole_active(8) & (!\moles_fsm_proc~8_combout\ & (\mole_active~8_combout\))) # (!mole_active(8) & (((\Decoder0~15_combout\)))), GLOBAL(\fastclock~combout\), VCC, , , , , !\game_state~regout\, )
...
\mole_duration[8]\ : maxv_lcell
-- Equation(s):
-- mole_duration(8) = DFFEAS((mole_duration(8) & (((!\Equal2~1_combout\)) # (!\mole_duration~16\))) # (!mole_duration(8) & (\Decoder0~15_combout\ & ((!\Equal2~1_combout\) # (!\mole_duration~16\)))), GLOBAL(\fastclock~combout\), VCC, , \game_state~regout\, , 
-- , , )
...
-- Equation(s):
-- \wrong_click~3_combout\ = (mole_active(7) & (\moles_fsm_proc~0\ & ((!mole_active(0))))) # (!mole_active(7) & ((\moles_fsm_proc~7\) # ((\moles_fsm_proc~0\ & !mole_active(0)))))
...
-- Equation(s):
-- \wrong_click~2_combout\ = (mole_active(6) & (!mole_active(5) & ((\moles_fsm_proc~5\)))) # (!mole_active(6) & ((\moles_fsm_proc~6\) # ((!mole_active(5) & \moles_fsm_proc~5\))))
...
-- Equation(s):
-- \wrong_click~4_combout\ = (\wrong_click~0_combout\) # ((\wrong_click~3_combout\) # ((\wrong_click~2_combout\) # (\wrong_click~1_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \wrong_click~0_combout\,
	datab => \wrong_click~3_combout\,
	datac => \wrong_click~2_combout\,
...
-- Equation(s):
-- \trigger_miss~regout\ = DFFEAS((\wrong_click~4_combout\) # ((!button_prev(8) & (\button~combout\(8) & !mole_active(8)))), GLOBAL(\fastclock~combout\), VCC, , , , , !\game_state~regout\, )
...
PORT MAP (
	clk => \fastclock~combout\,
	dataa => \game_state~1_combout\,
	datab => \game_fsm_proc~0\,
...
-- pragma translate_on
PORT MAP (
	dataa => \game_fsm_proc~0\,
	datac => \game_state~1_combout\,
...
-- Equation(s):
-- game_duration_timer(3) = DFFEAS((((!\Add3~15_combout\ & \game_state~regout\))), GLOBAL(\fastclock~combout\), VCC, , \game_duration_timer[4]~1_combout\, , , , )
...
-- Equation(s):
-- \game_state~regout\ = DFFEAS((\game_state~regout\ & (((\game_state~1_combout\)))) # (!\game_state~regout\ & (!\startButton_prev~regout\ & (!\startButton~combout\))), GLOBAL(\fastclock~combout\), VCC, , , , , , )
...
-- Equation(s):
-- \score_reset~reg0_regout\ = DFFEAS((!\startButton_prev~regout\ & (!\startButton~combout\ & ((!\game_state~regout\)))), GLOBAL(\fastclock~combout\), VCC, , , , , , )
...
-- Equation(s):
-- \trigger_hit~1_combout\ = (mole_active(3) & ((\moles_fsm_proc~3\) # ((mole_active(4) & \moles_fsm_proc~4\)))) # (!mole_active(3) & (mole_active(4) & ((\moles_fsm_proc~4\))))
...
-- Equation(s):
-- \trigger_hit~2_combout\ = (\moles_fsm_proc~6\ & ((mole_active(6)) # ((mole_active(5) & \moles_fsm_proc~5\)))) # (!\moles_fsm_proc~6\ & (mole_active(5) & ((\moles_fsm_proc~5\))))
...
-- Equation(s):
-- \trigger_hit~4_combout\ = (\trigger_hit~1_combout\) # ((\trigger_hit~3_combout\) # ((\trigger_hit~2_combout\) # (\trigger_hit~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \trigger_hit~1_combout\,
	datab => \trigger_hit~3_combout\,
	datac => \trigger_hit~2_combout\,
	datad => \trigger_hit~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \trigger_hit~regout\ = DFFEAS((\trigger_hit~4_combout\) # ((\button~combout\(8) & (mole_active(8) & !button_prev(8)))), GLOBAL(\fastclock~combout\), VCC, , , , , !\game_state~regout\, )
...
-- Equation(s):
-- score_timer(0) = DFFEAS(((\trigger_hit~regout\) # ((score_timer(1) & !score_timer(0)))), GLOBAL(\fastclock~combout\), VCC, , , , , , )
...
-- Equation(s):
-- score_timer(1) = DFFEAS(((\trigger_hit~regout\) # ((score_timer(1) & score_timer(0)))), GLOBAL(\fastclock~combout\), VCC, , , , , , )
...
-- Equation(s):
-- \score_high~reg0_regout\ = DFFEAS(((score_timer(1)) # ((\trigger_hit~regout\) # (score_timer(0)))), GLOBAL(\fastclock~combout\), VCC, , , , , , )
